...
11. ARABIC MATH SYMBOLS: When extracting Arabic math variables (like ق, س, ص, ع):
   ...
   - FOR SUBSCRIPTS: Use standard <msub> (e.g., ق₁ becomes <math dir="rtl"><msub><mi>ق</mi><mn>١</mn></msub></math>).
   ...
   - IMPORTANT: For equations mixing Arabic variables with operators (like ق₁ = expr), ensure the subscripted variable comes FIRST in MathML structure before the operator.`
